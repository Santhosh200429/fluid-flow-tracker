      ...
      {selectedGender === "male" && (
        <div className="mt-6 space-y-4">
          <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
            <h3 className="flex items-center text-lg font-semibold text-blue-700 dark:text-blue-300 mb-2">
          ...
          <div className="bg-amber-50 dark:bg-amber-900/20 p-4 rounded-lg">
            <h3 className="flex items-center text-lg font-semibold text-amber-700 dark:text-amber-300 mb-2">
